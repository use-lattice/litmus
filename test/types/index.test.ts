...
// AJV config-schema tests removed — site/static/config-schema.json not present in litmus fork
...
describe('TestSuiteConfigSchema', () => {
  ...
  // "should find configuration files" test removed — examples/ dir not present in litmus fork
